 ...
 * 26. PageIndicator
 * 27. ArtsParallax
 * 28. PJAX Animate Cloned Image
 * 29. PJAX Clone Image
 * 30. PJAX Fallback Cloned Image
 * 31. PJAX Finish Loading
 * 32. PJAX Init New Page
 * 33. PJAX Set Next Container
 * 34. PJAX Start Loading
 * 35. PJAX Transition Flying Image
 * 36. PJAX Transition Fullscreen Slider
 * 37. PJAX Transition General
 * 38. PJAX Transition List Hover
 * 39. PJAX Transition Overlay Menu
 * 40. PJAX Update Admin Bar
 * 41. PJAX Update Audio Background
 * 42. PJAX Update Body
 * 43. PJAX Update Head
 * 44. PJAX Update Language Switcher
 * 45. PJAX Update Nodes
 * 46. PJAX Update Trackers
 * 47. PJAX
 * 48. Preloader
 * 49. PSWPAlbum
 * 50. PSWPGallery
 ...
 */
  ...
  function Preloader({
    ...
    this.cursor.follower.element = this.cursor.element.find(
      '.cursor__follower'
    );
  ...
  class SmoothScroll {
    ...
    _handleAnchorsScrolling() {
      $('.page-wrapper__content, #page-footer')
  ...
  class SectionProjectsSlider extends ScrollAnimation {
    ...
    set() {
      ...
      this.activeBgScale =
        gsap.getProperty(this.$activeBg.get(0), 'scale') || 1;
